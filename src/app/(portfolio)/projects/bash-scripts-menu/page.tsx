  ...
  return (
    <div className="max-w-3xl mx-auto md:mt-0 p-4 md:p-8 lg:p-12">
      ...
      <div className="max-w-3xl mx-auto md:mt-0 p-4 md:p-8 lg:p-12 text-justify">
        <p className="my-3">
          This project consists of a set of Bash scripts that perform various text analysis operations on a predetermined text. The scripts are
          packaged into a Docker image for easy execution.{" "}
        </p>
        <h1 className="text-2xl font-bold my-3 ">Project Structure</h1>
        <ol className="flex flex-col gap-3">
          <li className="text-xl font-bold my-2 flex items-center">
            <ArrowRight />
            menu.sh
          </li>
...
exit 0`}
        ...
        <p className="my-3">
          I have improved and optimized the code but here you can find the original in this{" "}
          <Link className="font-semibold" href="https://github.com/Jazbarrionuev0/TP_Final_Entorno">
            repository
          </Link>
          .{" "}
        </p>
