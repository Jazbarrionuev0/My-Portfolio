  ...
  return (
    <div className="max-w-3xl mx-auto md:mt-0 p-4 md:p-8 lg:p-12">
      ...
      <p className="mt-4 md:mt-6 lg:mt-8 text-sm md:text-base lg:text-lg">
        I'm a software developer dedicated to create innovative solutions with careful design, efficient programming, and
        seamless deployment.
      </p>
      <p className="text-sm md:text-base lg:text-lg mt-3">Here&lsquo;s a snapshot of my journey!</p>
