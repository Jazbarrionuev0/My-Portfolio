  ...
  return (
    <div className="max-w-3xl mx-auto md:mt-0 p-4 md:p-8 lg:p-12">
      ...
      <p className=" md:mt-6 lg:mt-8 text-base md:text-base lg:text-lg">
        ...
        <span className="font-semibold">Cross Clues </span> , un juego de pistas cooperativo que me gusto mucho.
      </p>
      ...
      <div className="flex flex-col gap-5 items-center m-5">
        <Image className="rounded-md " src={"/crosscluesIMG3.png"} alt="crossclues" width={1916} height={943} />
        <Image className="rounded-md " src={"/crosscluesIMG4.png"} alt="crossclues" width={1506} height={936} />
      </div>
      <div className="m-10">
