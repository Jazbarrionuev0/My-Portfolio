  ...
  return (
    <div className="max-w-3xl mx-auto md:mt-0 p-4 md:p-8 lg:p-12">
      ...
      <div className="">
        ...
        <TagContainer tags={Algorithm} />
      </div>
      <div className="max-w-3xl mx-auto md:mt-0 p-4 md:p-8 lg:p-12 text-justify">
        <p className="my-3">
          This project is dedicated to implementing various algorithms using Python that I have developed during my Associate&apos;s Degree in
          Artificial Intelligence. The project features a range of algorithms, including some{" "}
          <Link className="font-semibold" href="#sorting">
            sorting methods
          </Link>
          ,{" "}
          <Link className="font-semibold" href="#binarytree">
            binary tree structures
          </Link>
          , and{" "}
          <Link className="font-semibold" href="#pathfinding">
        ...
        <p className="my-3">
          {" "}
          Apart from what I learned at the university, I also enjoy reading. Here are some of the books that have helped me learn and improve my
          understanding of algorithms:{" "}
          <Link className="font-semibold" href="https://www.amazon.com/Learning-Algorithms-Programmers-Writing-Better/dp/1492091065">
            Learning Algorithms: A Programmer’s Guide to Writing Better Code by O&apos;Reilly
          </Link>{" "}
          and{" "}
          <Link className="font-semibold" href="https://www.amazon.com/Structures-Algorithms-Python-Michael-Goodrich/dp/1118290275">
        ...
        <p className="my-3">
          I wont be showing all the algorithms but you can find the complete code{" "}
          <Link className="font-semibold" href="https://colab.research.google.com/drive/1Oubs8a1bNVjz4P8MJyidJAOx3LcnuFxH#scrollTo=vwFYbWdOaJuE">
            here
          </Link>
          .{" "}
        </p>
        ...
        {/* SORTING */}
        <h1 id="sorting" className="text-3xl font-bold my-3 ">
          Sorting methods
        </h1>
        ...
        <ol className="flex flex-col gap-3">
          ...
          <p>First-In-First-Out data structure</p>
          <Rio
            code={`%%file test_supermarket.py
          ...
          <p>Here the elements have associated priorities</p>
          <Rio
            code={`%%file test_priority_queue.py
class PriorityQueue:
    def __init__(self):
        self.queue = []
    ...
    def __str__(self):
        ...
        {/* BINARY TREE */}
        <h1 id="binarytree" className="text-3xl font-bold my-3 ">
          Binary Trees
        </h1>
        <ol className="flex flex-col gap-3">
          <li className="text-xl font-bold my-2 flex items-center">Binary Tree</li>
          <Rio
            code={`%%file test_tree.py
...
class Tree:
  ...
  def altura(self):
    ...
    return 1 + max(altural, alturar)`}
          ...
          <p>
            This algorithm is a special type of binary tree that focus on efficient searching, insertion, and deletion operations. And like George
            Heineman says, it is &apos;the godfather of all recursive data structures&apos;.
          </p>
          <Rio
            code={`%%file test_binary_search_tree.py
  ...
  def insertar(self, val):
    if val <= self.value:
      ...
      if self.right is None:
        ...
        {/* PATH FINDING */}
        <h1 id="pathfinding" className="text-3xl font-bold my-3 ">
          Path Finding
        </h1>
        <ol className="flex flex-col gap-3">
          ...
          <Rio
            code={`from ..models.grid import Grid
...
class UniformCostSearch:
    ...
    def search(grid: Grid) -> Solution:
        ...
        <p className="my-3">
          You can find the complete code of Path Finding Algorithms in this{" "}
          <Link className="font-semibold" href="https://github.com/Jazbarrionuev0/PathFinding-A-BFS-DFS-GBFS-GORIGHT-UCS">
            repository
          </Link>
          .{" "}
        </p>
